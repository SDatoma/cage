...
--
-- Hôte : 127.0.0.1
-- Généré le :  Dim 31 jan. 2021 à 08:31
...
(1, 'files_upload/slider/Bonjour a tous.jpg', 'Bonjour a tous', 1),
(2, 'files_upload/slider/Salut.jpg', 'Salut', 1);
...
INSERT INTO `user` (`id_user`, `nom_user`, `prenom_user`, `email_user`, `password_user`, `sexe_user`, `telephone_user`, `id_role`, `ok_newsletter`, `type_user`, `id_ville`, `quartier_user`) VALUES
(2, 'Fofana', 'bilali', 'fofb@gmail.com', '$2y$10$HgOlep1JuS3LxMMrUgPX0uaFhB1lOmzbuwxmQm5Qul1vejHpBYkCW', 'M', 89789098, NULL, 1, 2, '1', 'Agbalepedo'),
(3, 'ALASSANI', 'bilali', 'alassani@gmail.com', '$2y$10$cpOqdGSnp8p39Bv08hqvIOylNt7jSAQ4cL6W4xiUV7hqSxyItB/sS', 'M', 89789098, NULL, 1, 2, '3', NULL),
(4, 'fgfhghgh', 'hghjhgjhj', 'mamadou@gmail.com', '$2y$10$83Sxi7QCw92zhO5Q8a8/cOon/6o5S.b8WqmrTtXSaSfgH1BlNmaB.', 'F', 89789098, NULL, 1, 2, '2', NULL);
...
--
ALTER TABLE `photo_produit`
  MODIFY `id_photo_produit` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=20;
...
--
ALTER TABLE `remise`
  MODIFY `id_remise` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
