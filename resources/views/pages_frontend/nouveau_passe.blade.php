                                        ...
                                        <div class="login-form-container">
                                            <div class="login-register-form"  style="color:#000; text-align : right;">
                                                <form action="{{route('password.update', $password->id_user)}}" method="post">
                                                     {{ method_field('PUT') }}
														{{ csrf_field() }}
													<div class="col-lg-4">Adresse email : </div> <div class="col-lg-8"> <input type="email"  disabled="" value="{{$password->email_user}}" required=""/> </div>
													<input type="hidden" name="username" value="{{$password->email_user}}" required=""/>
