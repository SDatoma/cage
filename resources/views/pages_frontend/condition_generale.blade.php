		...
		<div class="agile_inner_breadcrumb">
			<div class="container">
				<ul class="w3_short">
					...
					<li>CONDITIONS GENERALE DE VENTE</li>
				</ul>
			</div>
		</div>
	</div>
...
Les CGV expriment l’intégralité des obligations des parties. Le client est réputé de les accepter sans réserve, faute de quoi sa commande ne sera pas validée.
...
Le prix du transport peut être variable en fonction de la nature du produit, son poids, le lieu de livraison et le montant de la commande.
Le chiffrage des frais de transport est évalué au cas par cas et devra faire l'objet d'une demande spécifique.
...
Le client a l’obligation de vérifier la marchandise lors de la réception et doit signer le bordereau de livraison et garder une copie.
Toute marchandise endommagée doit être signalée immédiatement ou dans les 24heures au plus après la réception de la marchandise. Vous contactez directement CAGE par email ou par téléphone. Le client est tenu d’aviser le transporteur et de prendre des photos claires des parties endommagées pour les envoyer par email à CAGE. N’oubliez pas de mettre la description des dommages.
Une pièce d’identité avec photo provenant d’un organisme gouvernemental devra obligatoirement être présentée à la prise de possession de la marchandise.
Les marchandises endommagées seront remplacées si elles ont été signalées au transporteur et que CAGE a été avisé des dommages dans un délai de 24heures.
La livraison n’est faite qu’après confirmation du client par téléphone ou email.
...
Sont considérés comme cas de force majeure déchargeant CAGE de son obligation de livrer, outre ceux habituellement retenus par la jurisprudence, la guerre, l'émeute, les grèves totales ou partielles, internes ou externes à l'entreprise, lock-out, intempéries, épidémies, pandémies, blocage des moyens de transport ou d'approvisionnement pour quelque raison que ce soit, tremblement de terre, incendie, tempête, inondation, dégâts des eaux, restrictions gouvernementales ou légales, modifications légales ou réglementaires des formes de commercialisation, panne d'ordinateur, blocage des télécommunications.
...
Le client devra, le cas échéant, informer le vendeur de ses constats par téléphone ou par <strong style="color:red">email à l’adresse suivante</strong>: 
...
Toute rétractation ou retour non effectué dans les règles définies ci-dessus et dans les délais impartis ne pourra être pris en compte et dégagera CAGE de toute responsabilité vis-à-vis du client.
