...
--
-- Hôte : 127.0.0.1
-- Généré le :  sam. 06 fév. 2021 à 19:39
...
INSERT INTO `ligne_commande` (`id_ligne_commande`, `quantite_commande`, `prix_commande`, `id_commande`, `reference_commande`, `id_produit`) VALUES
(1, 1, 3900, 1, 'fzdkb', 2),
(2, 1, 85500, 2, 'njrb3', 4),
(3, 1, 12400, 2, 'njrb3', 12),
(4, 1, 4300, 2, 'njrb3', 6);
...
INSERT INTO `produit` (`id_produit`, `nom_produit`, `description_produit`, `prix_ht_produit`, `tva_applicable`, `taux_tva`, `prix_ttc`, `quantite_produit`, `stock_produit`, `nouveau_produit`, `etat_produit`, `id_categorie`, `id_sous_categorie`, `id_boutique`, `caracteristique_produit`, `image_produit`) VALUES
(1, 'Ampoule 12 volt', '<p>rtytruytuyuy tuyi hjhk<br></p>', 1200, 'oui', 3, 1164, 20, NULL, 'Existant', 1, 2, 3, 1, '<p>tryytuyiu gjhk hkhjk<br></p>', 'files_upload/produit/Ampoule 12 volt.jpg'),
(2, 'Peinture au sol 80kp', '<p>gfh gjhjhk jkjl<br></p>', 3900, 'non', 0, 3900, 12, NULL, 'Existant', 1, 1, 2, 1, '<p>ytu gjhhjhk yiuoi yiuoio<br></p>', 'files_upload/produit/Peinture au sol 80kp.jpg'),
(3, 'Iphone 11', '<p>fgfdhgfh<br></p>', 110000, 'oui', 2, 107800, 23, NULL, 'Nouveau', 1, 3, 6, 1, '<p>gfhgjhgk<br></p>', 'files_upload/produit/Iphone 11.jpg'),
(4, 'Tecno spark 4', '<p>fhghgj<br></p>', 90000, 'oui', 5, 85500, 11, NULL, 'Existant', 1, 3, 5, 1, '<p>ghhgkjklj<br></p>', 'files_upload/produit/Tecno spark 4.jpg'),
(5, 'Carreaux 3 m cube', '<p>rettrytu yiui hjkhk<br></p>', 3500, 'oui', 1, 3465, 27, NULL, 'Existant', 1, 5, 7, 1, '<p>ytru yiyuouj hkjkl<br></p>', 'files_upload/produit/Carreaux 3 m cube.jpg'),
(6, 'Pot wc 20mm', '<p>tytryuyt yiuiui<br></p>', 4300, 'non', 0, 4300, 5, NULL, 'Existant', 1, 5, 9, 1, '<p>tyutyiyu hkjkljl<br></p>', 'files_upload/produit/Pot wc 20mm.jpg'),
(7, 'Lait caille', '<p>gfhgjhjh hjhkh<br></p>', 1630, 'non', 0, 1630, 12, NULL, 'Existant', 1, 1, 2, 1, '<p>yuyiuoipo hjhkj<br></p>', 'files_upload/produit/7.jpg'),
(8, 'Cahier 200 p', '<p>gfhgfjhj<br></p>', 200, 'oui', 3, 194, 18, NULL, 'Existant', 1, 2, 4, 1, '<p>tytuyuiyu<br></p>', 'files_upload/produit/Cahier 200 p.jpg'),
(9, 'Infinix hot 10', '<p>fghfgjhkh<br></p>', 95000, 'oui', 1, 94050, 9, NULL, 'Existant', 1, 3, 5, 1, '<p>tyuyuyuiuy<br></p>', 'files_upload/produit/Infinix hot 10.jpg'),
(10, 'Ademe', '<p>fdgfh<br></p>', 150, 'non', 0, 150, 11, NULL, 'Existant', 1, 1, 1, 1, '<p>ghgjhkj<br></p>', 'files_upload/produit/10.jpg'),
(11, 'Carrote', '<p>fgfhghj<br></p>', 430, 'oui', 2, 421, 5, NULL, 'Existant', 1, 2, 4, 1, '<p>ghjhjk<br></p>', 'files_upload/produit/11.jpg'),
(12, 'Sodigaz 6kg', '<p>gfhgfhg<br></p>', 12400, 'non', 0, 12400, 50, NULL, 'Existant', 1, 1, 1, 1, '<p>gjhjhk<br></p>', 'files_upload/produit/Sodigaz 6kg.jpg'),
(13, 'Enora gaz 6kg', '<p>Enora <br></p>', 12900, 'oui', 4, 12384, 6, NULL, 'Nouveau', 1, 1, 1, 1, '<p>fgfdhgfh<br></p>', 'files_upload/produit/Enora gaz 6kg.jpg'),
(14, 'Grillage metallique 1x2m', '<p>fgfhgfhjgjg</p>', 2900, 'non', 0, 2900, 40, NULL, 'Existant', 1, 1, 1, 1, '<p>ghgfjghj</p>', 'files_upload/produit/g1.jpg.jpg'),
(15, 'Pot de Wc', '<p>ghhgjhkj</p>', 567, 'oui', 5, 539, 4, NULL, 'Nouveau', 1, 1, 2, 1, '<p>hjhkhjkj</p>', 'files_upload/produit/PotdeWc.jpg'),
(16, 'Biscuit', '<p>reytrytu<br></p>', 1600, 'oui', 4, 1536, 30, NULL, 'Existant', 1, 5, 8, 2, '<p>yuyiuiuo<br></p>', 'files_upload/produit/Biscuit.jpg');
